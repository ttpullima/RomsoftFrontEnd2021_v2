...
{ 
    public partial class frmListaPresupuesto : Form
    {
        public int intTipoConsulta = 0;

        public frmListaPresupuesto()
        {
            InitializeComponent();
        }
        ...
        {
            Presupuesto.frmFiltroPresupuesto frm = new Presupuesto.frmFiltroPresupuesto();
        ...
        {
            Presupuesto.frmNuevoPresupuesto frm = new Presupuesto.frmNuevoPresupuesto();
            if (frm.ShowDialog() == DialogResult.OK)
            {
                // 0 = Consulta Todos
                //    InitialLoad(0);
