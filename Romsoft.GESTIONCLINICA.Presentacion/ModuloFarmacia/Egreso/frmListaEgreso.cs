...
{
    public partial class frmListaEgreso : Form
    {
        ...
        {
            Egreso.frmFiltroEgreso frm = new Egreso.frmFiltroEgreso();
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            Egreso.frmNuevoEgreso frm = new Egreso.frmNuevoEgreso();
        ...
        {
            Egreso.frmNuevoOtros frm = new Egreso.frmNuevoOtros();
